...
@Component
public class ThongKePhongNamGUI extends JFrame {
...
//				barChart_AWT.setVisible( true ); 
	...
	public List<ThongKePhongThang> findAllByThangLapHoaDon(List<HoaDon> listHoaDon,int namLapHoaDon){
		List<ThongKePhongThang> list=new ArrayList<ThongKePhongThang>();
		setLabelEmpty();
		listHoaDon.stream()
			.filter(hoaDon->
